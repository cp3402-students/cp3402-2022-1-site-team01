...
_defineProperty(MySqlFormatter, "reservedCommands", reservedCommands);

_defineProperty(MySqlFormatter, "reservedBinaryCommands", reservedBinaryCommands);

_defineProperty(MySqlFormatter, "reservedDependentClauses", reservedDependentClauses);

_defineProperty(MySqlFormatter, "reservedJoinConditions", ['ON', 'USING']);

_defineProperty(MySqlFormatter, "reservedLogicalOperators", ['AND', 'OR', 'XOR']);

_defineProperty(MySqlFormatter, "reservedKeywords", (0, _utils.dedupe)([].concat(reservedKeywords, reservedFunctions)));

_defineProperty(MySqlFormatter, "stringTypes", ['``', "''", '""']);

_defineProperty(MySqlFormatter, "blockStart", ['(', 'CASE']);

_defineProperty(MySqlFormatter, "blockEnd", [')', 'END']);

_defineProperty(MySqlFormatter, "indexedPlaceholderTypes", ['?']);

_defineProperty(MySqlFormatter, "namedPlaceholderTypes", []);

_defineProperty(MySqlFormatter, "lineCommentTypes", ['--', '#']);
