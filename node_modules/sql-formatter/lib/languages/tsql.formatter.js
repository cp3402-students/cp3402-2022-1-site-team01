...
_defineProperty(TSqlFormatter, "reservedCommands", reservedCommands);

_defineProperty(TSqlFormatter, "reservedBinaryCommands", reservedBinaryCommands);

_defineProperty(TSqlFormatter, "reservedDependentClauses", reservedDependentClauses);

_defineProperty(TSqlFormatter, "reservedJoinConditions", ['ON', 'USING']);

_defineProperty(TSqlFormatter, "reservedLogicalOperators", ['AND', 'OR']);

_defineProperty(TSqlFormatter, "reservedKeywords", (0, _utils.dedupe)([].concat(_toConsumableArray(Object.values(reservedFunctions).reduce(function (acc, arr) {
...
_defineProperty(TSqlFormatter, "blockStart", ['(', 'CASE']);

_defineProperty(TSqlFormatter, "blockEnd", [')', 'END']);

_defineProperty(TSqlFormatter, "indexedPlaceholderTypes", []);

_defineProperty(TSqlFormatter, "namedPlaceholderTypes", ['@']);

_defineProperty(TSqlFormatter, "lineCommentTypes", ['--']);
