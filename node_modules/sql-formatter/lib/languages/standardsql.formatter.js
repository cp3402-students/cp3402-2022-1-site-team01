...
_defineProperty(StandardSqlFormatter, "reservedCommands", reservedCommands);

_defineProperty(StandardSqlFormatter, "reservedBinaryCommands", reservedBinaryCommands);

_defineProperty(StandardSqlFormatter, "reservedDependentClauses", reservedDependentClauses);

_defineProperty(StandardSqlFormatter, "reservedJoinConditions", ['ON', 'USING']);

_defineProperty(StandardSqlFormatter, "reservedLogicalOperators", ['AND', 'OR']);

_defineProperty(StandardSqlFormatter, "reservedKeywords", (0, _utils.dedupe)(reservedKeywords));

_defineProperty(StandardSqlFormatter, "stringTypes", ["\"\"", "''", '``']);

_defineProperty(StandardSqlFormatter, "blockStart", ['(', 'CASE']);

_defineProperty(StandardSqlFormatter, "blockEnd", [')', 'END']);

_defineProperty(StandardSqlFormatter, "indexedPlaceholderTypes", ['?']);

_defineProperty(StandardSqlFormatter, "namedPlaceholderTypes", []);

_defineProperty(StandardSqlFormatter, "lineCommentTypes", ['--']);

_defineProperty(StandardSqlFormatter, "operators", []);

module.exports = exports.default;
//# sourceMappingURL=standardsql.formatter.js.map