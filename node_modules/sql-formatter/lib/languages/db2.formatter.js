...
_defineProperty(Db2Formatter, "reservedCommands", reservedCommands);

_defineProperty(Db2Formatter, "reservedBinaryCommands", reservedBinaryCommands);

_defineProperty(Db2Formatter, "reservedDependentClauses", reservedDependentClauses);

_defineProperty(Db2Formatter, "reservedJoinConditions", ['ON', 'USING']);

_defineProperty(Db2Formatter, "reservedLogicalOperators", ['AND', 'OR']);

_defineProperty(Db2Formatter, "fullReservedWords", (0, _utils.dedupe)([].concat(_toConsumableArray(Object.values(reservedFunctions).reduce(function (acc, arr) {
...
_defineProperty(Db2Formatter, "blockStart", ['(']);

_defineProperty(Db2Formatter, "blockEnd", [')']);

_defineProperty(Db2Formatter, "indexedPlaceholderTypes", ['?']);

_defineProperty(Db2Formatter, "namedPlaceholderTypes", [':']);

_defineProperty(Db2Formatter, "lineCommentTypes", ['--']);
