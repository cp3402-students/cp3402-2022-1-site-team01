...
var MariaDbFormatter = /*#__PURE__*/function (_Formatter) {
  ...
  _createClass(MariaDbFormatter, [{
    ...
    value: function tokenOverride(token) {
      // [SET] ( ...
      if (_token.isToken.SET(token) && this.tokenLookAhead().value === '(') {
...
_defineProperty(MariaDbFormatter, "reservedCommands", reservedCommands);

_defineProperty(MariaDbFormatter, "reservedBinaryCommands", reservedBinaryCommands);

_defineProperty(MariaDbFormatter, "reservedJoinConditions", ['ON', 'USING']);

_defineProperty(MariaDbFormatter, "reservedLogicalOperators", ['AND', 'OR', 'XOR']);

_defineProperty(MariaDbFormatter, "reservedDependentClauses", reservedDependentClauses);

_defineProperty(MariaDbFormatter, "reservedKeywords", (0, _utils.dedupe)([].concat(reservedKeywords, reservedFunctions)));

_defineProperty(MariaDbFormatter, "stringTypes", ['``', "''", '""']);

_defineProperty(MariaDbFormatter, "blockStart", ['(', 'CASE']);

_defineProperty(MariaDbFormatter, "blockEnd", [')', 'END']);

_defineProperty(MariaDbFormatter, "indexedPlaceholderTypes", ['?']);

_defineProperty(MariaDbFormatter, "namedPlaceholderTypes", []);

_defineProperty(MariaDbFormatter, "lineCommentTypes", ['--', '#']);
